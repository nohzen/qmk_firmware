...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
          KC_ESC,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,             KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, TD(TD_BRC), KC_RBRC,
         ...
         KC_LCTL,          KC_LGUI,           LW_SPC,    KC_A,             KC_A,   MO(2),          KC_LALT,           KC_ENT
    ),
    [1] = LAYOUT(
         KC_TRNS,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,             KC_6,    KC_7,    KC_8,    KC_9,    KC_0,      KC_NO, KC_NO,
    ...
    [2] = LAYOUT(
         KC_TRNS,   KC_NO,   KC_NO, KC_WH_U,   KC_NO,   KC_NO,            KC_NO,   KC_NO,   KC_NO,   KC_NO, KC_PSCR,     KC_NO, KC_NO,

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
      KC_GRV,  KC_EXLM, KC_UP, KC_END, KC_DLR, KC_PERC, KC_CIRC, KC_LCBR, KC_RCBR, KC_AMPR, KC_HASH, KC_UNDS, \
    ...
    [2] = LAYOUT(
      ...
      QK_BOOT, _______, _______, _______, KC_CIRC, KC_SLSH, KC_AMPR, KC_PIPE, KC_COMM, KC_PERC, KC_EXLM,  \
      _______, _______, _______, _______, _______, _______ \
    )
};

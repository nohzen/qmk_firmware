...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_LSFT,  KC_A,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,
        KC_LCTL,    KC_LALT,     KC_LGUI,           LW_SPC,            MO(2),          KC_LALT,    KC_RALT,    KC_A,    KC_LALT
    ),
    [1] = LAYOUT(
        ...
        KC_TRNS, KC_TRNS, KC_NO,   KC_NO,   KC_NO, KC_BTN3,   KC_NO,  KC_SPC,  KC_ENT,   KC_NO,   KC_NO,   KC_NO,
    ...
    [2] = LAYOUT(
        ...
        KC_TRNS,KC_TRNS,KC_VOLD, KC_VOLU, KC_MUTE,   KC_NO,   KC_NO, KC_HOME, KC_PGDN, KC_PGUP,  KC_END,   KC_NO,
